...
# Reply tables for message boards
cursor.execute('''CREATE TABLE IF NOT EXISTS Post_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, PostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
               FOREIGN KEY(PostID) REFERENCES Posts(PostID),
               FOREIGN KEY(TeacherID) REFERENCES Teachers(TeacherID))''')

cursor.execute('''CREATE TABLE IF NOT EXISTS M_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, MPostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
               FOREIGN KEY(MPostID) REFERENCES M_Posts(MPostID),
               FOREIGN KEY(TeacherID) REFERENCES Teachers(TeacherID))''')

cursor.execute('''CREATE TABLE IF NOT EXISTS E_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, EPostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
               FOREIGN KEY(EPostID) REFERENCES E_Posts(EPostID),
               FOREIGN KEY(TeacherID) REFERENCES Teachers(TeacherID))''')

cursor.execute('''CREATE TABLE IF NOT EXISTS S_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, SPostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
               FOREIGN KEY(SPostID) REFERENCES S_Posts(SPostID),
               FOREIGN KEY(TeacherID) REFERENCES Teachers(TeacherID))''')

cursor.execute('''CREATE TABLE IF NOT EXISTS C_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, CPostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
               FOREIGN KEY(CPostID) REFERENCES C_Posts(CPostID),
               FOREIGN KEY(TeacherID) REFERENCES Teachers(TeacherID))''')

cursor.execute('''CREATE TABLE IF NOT EXISTS H_Replies 
               (ReplyID INTEGER PRIMARY KEY AUTOINCREMENT, HPostID INTEGER, Content TEXT, 
               Date DATE, Time Text, TeacherID INTEGER, 
